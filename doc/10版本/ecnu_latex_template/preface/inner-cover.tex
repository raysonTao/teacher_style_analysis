...
\begin{center}
    \renewcommand\arraystretch{1.5}
    \begin{tabular}{l}
        \makebox[\coverlength][l]{\sihao \bf 院系:}~~\\
        \makebox[\coverlength][l]{\sihao \bf 专业:}\\
        \makebox[\coverlength][l]{\sihao \bf 研究方向:}\\
        \makebox[\coverlength][l]{\sihao \bf 指导教师:}\\
        \makebox[\coverlength][l]{\sihao \bf 学位申请人:}
    \end{tabular}
    \begin{tabular}c
        {\sihao \bf ~~~计算机科学与技术学院~~~}\\
        \hline {\sihao \bf 电子信息}\\
        \hline {\sihao \bf 计算机技术}\\
        \hline {\sihao \bf \ifnotanonymous ~~陈蕾~~副教授~~ \else *** \fi}\\
